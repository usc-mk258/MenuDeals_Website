...
var tractorService_1 = require("../service/tractorService");
var TractorController = /** @class */ (function () {
    function TractorController(service) {
        if (service === void 0) { service = new tractorService_1.TractorService(); }
        var _this = this;
        ...
        this.getOne = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("dsdas", req.params.id);
                        return [4 /*yield*/, this.service.getOne(req.params.id)];
                    case 1:
                        result = _a.sent();
                        req.body = result;
                        next();
...
exports.default = TractorController;
