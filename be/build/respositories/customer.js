...
var Repo = /** @class */ (function () {
    function Repo() {
        this.repo = typeorm_1.getConnection().getRepository(Customer_1.Customer);
    }
    Repo.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                customer = this.repo.create({ email: email, name: name, password: password });
                return [2 /*return*/, this.repo.save(customer)];
            });
        });
    };
