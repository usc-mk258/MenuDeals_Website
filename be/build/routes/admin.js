...
var controller = new adminController_1.default();
/**
 ...
 *
 */
router.get("/admin/restaurants", authorize_1.authorize(roles_1.Roles.Admin), controller.getAllRestaurant);
/**
 ...
 *
 */
router.get("/admin/restaurant/:id/:status", authorize_1.authorize(roles_1.Roles.Admin), controller.approveRestaurant);
