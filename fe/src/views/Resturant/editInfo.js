...
import { RESTURANT_ADD_INFO, RESTURANT_EDIT_INFO } from "Apis";
...
class EditInfo extends Component {
  ...
  componentWillMount() {
    axios
      ...
      .then((res) => {
        ...
        this.setLatLng(
          res.data.data.point.coordinates[1],
          res.data.data.point.coordinates[0]
        );
        this.setState({
  ...
  submit = () => {
    ...
    axios({
      ...
      console.log(res);
      this.props.history.push("/Resturant/deals");
    });
  };
  render() {
    console.log(this.state.description);
    ...
    console.log(this.state.lng);
    console.log(
      this.state.getInfo.point &&
        this.state.getInfo.point &&
        this.state.getInfo.point.coordinates
    );
                            ...
                            center: this.props.currentLocation
                              ...
                              : {
                                  centerlat:
                                    this.state.getInfo.point &&
                                    this.state.getInfo.point &&
                                    this.state.getInfo.point.coordinates[1],
                                  centerlng:
                                    this.state.getInfo.point &&
                                    this.state.getInfo.point &&
                                    this.state.getInfo.point.coordinates[0],
                                },
                          }}
